...
var registerApi = function registerApi(query) {
...
// 登陆
exports.registerApi = registerApi;var loginApi = function loginApi(query) {
  return (0, _http.apiResquest)({
    url: '/login/wechat',
    method: 'POST',
    query: query });
...
};exports.tickeCreate = tickeCreate;
var tickeDetail = function tickeDetail(query) {
  return (0, _http.apiResquest)({
    url: '/manager/ticket/' + query.id + '/detail',
    method: 'get' });

};exports.tickeDetail = tickeDetail;
var tickeAppend = function tickeAppend(query) {
  return (0, _http.apiResquest)({
    url: '/manager/ticket/' + query.id + '/append',
    method: 'post',
    query: query.data });

};exports.tickeAppend = tickeAppend;
var tickeRemove = function tickeRemove(query) {
  return (0, _http.apiResquest)({
...
// 	})
// }
exports.attendanceList = attendanceList;var attendanceTime = function attendanceTime(query) {
  return (0, _http.apiResquest)({
